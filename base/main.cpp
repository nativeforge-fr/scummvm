...
extern "C" int scummvm_main(int argc, const char * const argv[]) {
	...
	// Bilinear filtering OFF by default (user preference): crisp pixels. Can be
	// toggled in the in-game options ("Filtrage image").
	if (!ConfMan.hasKey("filtering", Common::ConfigManager::kApplicationDomain))
		ConfMan.setBool("filtering", false, Common::ConfigManager::kApplicationDomain);
#endif
